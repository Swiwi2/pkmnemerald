...
#define VAR_STARTER_MON                                  0x4023 // 0=Water, 1=Fire, 2=Grass
...
#define VAR_WOODHOLME_STATE                              0x404E // Used to determine if we may leave Woodholme City to Route 1.
#define VAR_LOTAD_SIZE_RECORD                            0x404F
#define VAR_LITTLEROOT_TOWN_STATE                        0x4050
#define VAR_OLDALE_TOWN_STATE                            0x4051
#define VAR_WOODHOLME_LAB_STATE                          0x4052 // Unused Var
...
#define VAR_STARTER_SELECTION                            0x40F7 // Used for custom starter selection.
#define VAR_GAMEINTRO_STATE                              0x40F8 // Used to define which dialogue options MOM should offer in the apartment.
