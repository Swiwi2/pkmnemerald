static const struct CityMapEntry sPokenavCityMaps[NUM_CITY_MAPS] =
{
    ...
    {
        .mapSecId = MAPSEC_WOODHOLME_CITY,
        .index = 0,
        .tilemap = gPokenavCityMap_Petalburg_0,
    },
    {
        .mapSecId = MAPSEC_ATOM_ISLAND,
        .index = 0,
    ...
    {
        .mapSecId = MAPSEC_SERENLEAF_CITY,
        .index = 0,
    ...
    {
        .mapSecId = MAPSEC_AMBERVILLE_CITY,
        .index = 0,
    ...
    {
        .mapSecId = MAPSEC_FARMVILLE_CITY,
        .index = 0,
        .tilemap = gPokenavCityMap_Fortree_0,
    },
    {
        .mapSecId = MAPSEC_PAKKASJARVEN_CITY,
        .index = 0,
    ...
    {
        .mapSecId = MAPSEC_EMBERVILLE_CITY,
        .index = 0,
