...
const u16 gMetatiles_Pakkasjarven[] = INCBIN_U16("data/tilesets/primary/pakkasjarven/metatiles.bin");
const u16 gMetatileAttributes_Pakkasjarven[] = INCBIN_U16("data/tilesets/primary/pakkasjarven/metatile_attributes.bin");
