static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SERENLEAF_CITY - 1] = {MAP_GROUP(SERENLEAF_CITY), MAP_NUM(SERENLEAF_CITY), 22, 6},
    [HEAL_LOCATION_AMBERVILLE_CITY - 1] = {MAP_GROUP(AMBERVILLE_CITY), MAP_NUM(AMBERVILLE_CITY), 10, 10},
    [HEAL_LOCATION_EMBERVILLE_CITY - 1] = {MAP_GROUP(EMBERVILLE_CITY), MAP_NUM(EMBERVILLE_CITY), 10, 10},
    [HEAL_LOCATION_ENIMEROS_CITY - 1] = {MAP_GROUP(ENIMEROS_CITY), MAP_NUM(ENIMEROS_CITY), 10, 10},
    [HEAL_LOCATION_PAKKASJARVEN_CITY - 1] = {MAP_GROUP(PAKKASJARVEN_CITY), MAP_NUM(PAKKASJARVEN_CITY), 10, 10},
    [HEAL_LOCATION_ATOM_ISLAND - 1] = {MAP_GROUP(ATOM_ISLAND), MAP_NUM(ATOM_ISLAND), 10, 10},
    [HEAL_LOCATION_FARMVILLE_CITY - 1] = {MAP_GROUP(FARMVILLE_CITY), MAP_NUM(FARMVILLE_CITY), 10, 10},
