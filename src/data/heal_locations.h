static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_AMBERVILLE_CITY - 1] = {MAP_GROUP(AMBERVILLE_CITY), MAP_NUM(AMBERVILLE_CITY), 5, 18},
    [HEAL_LOCATION_EMBERVILLE_CITY - 1] = {MAP_GROUP(EMBERVILLE_CITY), MAP_NUM(EMBERVILLE_CITY), 16, 5},
