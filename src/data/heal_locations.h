static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_WOODHOLME_CITY - 1] = {MAP_GROUP(WOODHOLME_CITY), MAP_NUM(WOODHOLME_CITY), 27, 18},
    [HEAL_LOCATION_SERENLEAF_CITY - 1] = {MAP_GROUP(SERENLEAF_CITY), MAP_NUM(SERENLEAF_CITY), 21, 6},
    [HEAL_LOCATION_AMBERVILLE_CITY - 1] = {MAP_GROUP(AMBERVILLE_CITY), MAP_NUM(AMBERVILLE_CITY), 16, 39},
    [HEAL_LOCATION_EMBERVILLE_CITY - 1] = {MAP_GROUP(EMBERVILLE_CITY), MAP_NUM(EMBERVILLE_CITY), 16, 29},
    [HEAL_LOCATION_ENIMEROS_CITY - 1] = {MAP_GROUP(ENIMEROS_CITY), MAP_NUM(ENIMEROS_CITY), 20, 17},
    [HEAL_LOCATION_PAKKASJARVEN_CITY - 1] = {MAP_GROUP(PAKKASJARVEN_CITY), MAP_NUM(PAKKASJARVEN_CITY), 17, 11},
    [HEAL_LOCATION_ATOM_ISLAND - 1] = {MAP_GROUP(ATOM_ISLAND), MAP_NUM(ATOM_ISLAND), 28, 17},
    [HEAL_LOCATION_FARMVILLE_CITY - 1] = {MAP_GROUP(FARMVILLE_CITY), MAP_NUM(FARMVILLE_CITY), 16, 12},
    [HEAL_LOCATION_POKEMON_LEAGUE - 1] = {MAP_GROUP(POKEMON_LEAGUE), MAP_NUM(POKEMON_LEAGUE), 10, 10},
    [HEAL_LOCATION_SOLAS_TOWN - 1] = {MAP_GROUP(SOLAS_TOWN), MAP_NUM(SOLAS_TOWN), 10, 10},
};
