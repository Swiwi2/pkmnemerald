...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_SOLAS_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PACIFIDLOG_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_WOODHOLME_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATOM_ISLAND] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SERENLEAF_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_AMBERVILLE_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_FARMVILLE_CITY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_PAKKASJARVEN_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_EMBERVILLE_CITY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_ENIMEROS_CITY] = MAPPOPUP_THEME_MARBLE,
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_SOLAS_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PACIFIDLOG_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_WOODHOLME_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ATOM_ISLAND] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SERENLEAF_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_AMBERVILLE_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FARMVILLE_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PAKKASJARVEN_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_EMBERVILLE_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ENIMEROS_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
